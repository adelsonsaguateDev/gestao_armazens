...
(function (factory) {
    ...
    $.fn.fileinputLocales['_LANG_'] = {
        ...
        msgInvalidFileType: 'Tipo de ficheiro inválido "{name}". apenas "{types}" são suportados.',
        msgInvalidFileExtension: 'Extensão inválida para o ficheiro "{name}". Apenas "{extensions}" são suportadas.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
