        ...
        <div class="main-content-wrap mobile-menu-content bg-off-white m-0">
            ...
            <div class="main-content pt-4">
                <div class="breadcrumb">
                    <h1 class="mr-2">Lista de Saídas</h1>
                    <ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="cliente_filtro" id="cliente_filtro"
        ...
        $(document).ready(function() {
            ...
            $('#registrar_saida').click(function() {
                ...
                $('#itens_saida_table tbody tr').each(function() {
                    ...
                    itens.push({produto_id: produto_id, qtd_caixas: qtd_caixas, qtd_por_caixa: qtd_por_caixa, preco_compra_caixa: preco_compra_caixa, preco_compra_unitario: preco_compra_unitario, preco_venda_caixa: preco_venda_caixa, preco_venda_unitario: preco_venda_unitario, data_validade: data_validade});
                });
