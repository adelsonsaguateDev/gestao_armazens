        ...
        <div class="main-content-wrap mobile-menu-content bg-off-white m-0">
            ...
            <div class="main-content pt-4">
                <div class="breadcrumb">
                    <h1 class="mr-2">Lista de Utilizadores</h1>
                    <ul>
                    </ul>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-right ">
                                        <button title="Adicionar novo utilizador" class="btn btn-success" type="button"
                                            data-toggle="modal" data-target="#rg_utilizador" id="btn_registar"><i
                                                class="fa fa-plus"></i> REGISTAR UTILIZADOR</button>
