                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-right ">
                                        <button title="Adicionar novo produto" class="btn btn-success" type="button"
                                            data-toggle="modal" data-target="#rg_produto" id="btn_registar"><i
                                                class="fa fa-plus"></i> REGISTRAR PRODUTO</button>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-3 mb-3">
                                        <label for="codigo_filtro"
                                            style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Código
                                            do produto</label>
                                        <input type="text" class="form-control" name="codigo_filtro"
                                            id="codigo_filtro" />
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="descricao_filtro"
                                            style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Descrição
                                            do produto</label>
                                        <input type="text" class="form-control" name="descricao_filtro"
                                            id="descricao_filtro" />
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="quantidade_filtro"
                                            style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Quantidade</label>
                                        <input type="number" class="form-control" name="quantidade_filtro"
                                            id="quantidade_filtro" />
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="stock_minimo_filtro"
                                            style="font-family: 'Arial narrow'; font-size: 14px; color: #2C304D; font-weight: 600;">Stock
                                            Mínimo</label>
                                        <input type="number" class="form-control" name="stock_minimo_filtro"
                                            id="stock_minimo_filtro" />
                                    </div>
                                    <div class="col-md-3 mb-3">
