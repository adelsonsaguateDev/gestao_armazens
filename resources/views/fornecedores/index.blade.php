...
@section('title', 'Lista de Fornecedores | Gestão de Armazens')
...
@section('content')
    ...
    <div class="app-admin-wrap layout-sidebar-vertical sidebar-full">
        ...
        @include('fornecedores.modal.AddFornecedor')
        @include('fornecedores.modal.form_edit')
        ...
        <div class="main-content-wrap mobile-menu-content bg-off-white m-0">
            ...
            <div class="main-content pt-4">
                <div class="breadcrumb">
                    <h1 class="mr-2">Lista de Fornecedores</h1>
                    <ul>
                    </ul>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-right ">
                                        <button title="Adicionar novo fornecedor" class="btn btn-success" type="button"
                                            data-toggle="modal" data-target="#rg_fornecedor" id="btn_registar"><i
                                                class="fa fa-plus"></i> REGISTAR FORNECEDOR</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", "#btn_edit", function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('.conteudo_fornecedor').html(response);
                        $('#edit_fornecedor').modal('show');
            ...
            $(document).on("click", "#btn_delete", function() {
                ...
                Swal.fire({
                    title: 'ALERTA!',
                    text: "Tem certeza que deseja apagar o fornecedor?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        update_estado(fornecedor_id, estado);
                    }
                });
            ...
            $(document).on("click", "#btn_show", function() {
                ...
                var fornecedor_id = $(this).val();
                var url = '{{ url('fornecedor') }}/' + fornecedor_id;
            ...
            function update_estado(fornecedor_id, estado) {
                showLoader();
                $.ajax({
                    url: '{{ url('fornecedor/delete') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
            ...
            $(document).on("click", "#btn_active", function() {
                ...
                Swal.fire({
                    title: 'ALERTA!',
                    text: "Tem certeza que deseja activar o fornecedor?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#0CC27E',
                    cancelButtonColor: '#FF586B',
            ...
            function list(page, limite) {
                ...
                $.ajax({
                    url: '{{ url('fornecedores') }}?page=' + page,
                    method: 'GET',
                    data: {
                        "estado": estado,
                        "nome": nome,
